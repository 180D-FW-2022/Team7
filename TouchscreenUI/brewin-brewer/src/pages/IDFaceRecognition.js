...
class IDFaceRecognition extends Component {
  constructor(props) {
    super(props);
        ...
        <Box height="100vh">
          ...
          <Box display="flex" justifyContent="center" alignItems="center" height="20vh" bgcolor={theme.palette.secondary.main}>
              <Typography
                ...
                >
                  Please center your ID picture in frame
                </Typography>
          </Box>
          ...
          <Box display="flex" justifyContent="center" alignItems="center" height="10vh">
            ...
            <Button variant="contained" href="/idfacenotmatched">
                Face Not Matched
            </Button>
...
export default IDFaceRecognition;
